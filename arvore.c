...
//Criando o nodo(registro) que pertencer� a minha �rvore
typedef struct nodo{
...
//Criando um ponteiro que aponta para minha �rvore
typedef struct{
	Nodo *raiz;
}Arvore;


//Criando a �rvore, o subprograma abaixo retornar� um ponteiro tree que aponta para a �rvore campo raiz, apontando para NULL(vazio/nulo)
Arvore * criando(){
...
void inserindo (Arvore *tree, int num){
	//num = numero informado pelo usu�rio
...
//Subprograma que localiza um numero na �rvore
...
//Subprograma recursivo que identifica o maior numero da �rvore
...
//Subprograma recursivo que identiica o menor numero da �rvore
...
void main(){
	...
	//Saber se o usu�rio deseja realizar mais alguma opera��o
	while (continuar == 's'){
		//Menu que informa as opera��es dispon�veis para o usu�rio
